...
start_str = 'def _interactive_html() -> str:\n'
end_str = '@app.get("/", response_class=HTMLResponse, include_in_schema=False)\n'
...
new_ui = '''def _interactive_html() -> str:
    return """
    <!doctype html>
    <html lang="en">
    <head>
